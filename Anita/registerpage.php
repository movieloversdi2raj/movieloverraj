...
<body >
<div id="backregister" style="background-image: url(img/backregister.JPG)">
    ...
    <div class="container"  >
        ...
        <div class="row" id="register">
            ...
            <form name="pay" action="insert.php">
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                ...
                                <div class="form-group form_align col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <input type="button" class="btn btn-default btn-md" value="register">
                                    </div>
                            </div>
                            <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1"></div>
                        </div>
